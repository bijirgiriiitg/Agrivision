...
const Notes = () => {
  ...
  return (
    <div style={{width:'55%',marginTop:'0%',marginLeft:'15%'}}>
        <div style={{display:'flex', flexDirection:'row', justifyContent:'center', alignItems: 'center'}}>
        <Heading>Food Technology : Agriculture machinery</Heading>
        <form onClick={handleClick}>
        <Button2 style={{backgroundColor: isActive ? '#0B6E4F' : '', color: isActive ? '#FFFFFF' : ''}} ><BookmarkBorderIcon ></BookmarkBorderIcon></Button2>
        </form>
        </div>
        <Text>
